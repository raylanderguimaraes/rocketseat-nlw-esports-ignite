                ...
                <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Input name="discord" id="discord" type="text" placeholder="Usuaário#00000" />
                    ...
                    <div className="flex gap-6 ">
                        ...
                        <div className=" flex flex-col gap-2">
                            ...
                            >
                                ...
                                <ToggleGroup.Item value="1" title="Seunda" className={`w-8 h-8 rounded  ${weekDays.includes('1') ? 'bg-violet-500' : 'bg-zinc-900'}`}>S</ToggleGroup.Item>
